...
const DEFAULT_MESSAGE = 'مرحباً، أريد الاستفسار عن أقمشة بن صديق';
...
export default function WhatsAppButton() {
  ...
  return (
    <div className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex flex-col items-end gap-2">
      ...
      {showTooltip && (
        <div
          className="animate-float-up px-3 py-2 rounded-xl text-xs font-bold text-white shadow-lg whitespace-nowrap"
          style={{ background: '#25D366' }}
        >
          تحدث معنا على واتساب! 💬
          <div className="absolute -bottom-1.5 right-4 w-3 h-3 rotate-45" style={{ background: '#25D366' }} />
        </div>
      )}
